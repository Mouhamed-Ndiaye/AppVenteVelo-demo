...
public class MiseAJourProduitDTO {
    ...
    public MiseAJourProduitDTO() {
    }

    public MiseAJourProduitDTO(Integer id, String nom, Integer marque, Integer categorie, short annee_model, BigDecimal prix_depart) {
        this.id = id;
        this.nom = nom;
        this.marque = marque;
